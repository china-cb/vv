		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Cms/Shop/cateSet/');?>" class="btn btn-primary" data-loader="Joel-loader" data-loadername="设置分组">
					...
					<div class="pull-right">
						<!--<form id="Joel-search">
							...
							<a href="<?php echo U('Cms/Shop/cate/');?>" class="btn btn-success" data-loader="Joel-loader" data-loadername="门店分组" data-search="Joel-search">
				...
				<table id="Joel-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class="center "><a href="<?php echo U('Cms/Shop/cateSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a><?php if(empty($vo["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Cms/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Shop/cateDel/',array('id'=>$vo['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
							</tr>
							<?php if(is_array($vo['_child'])): $i = 0; $__LIST__ = $vo['_child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo2["id"]); ?>">
									...
									<td class="center "><a href="<?php echo U('Cms/Shop/cateSet/',array('id'=>$vo2['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a><?php if(empty($vo2["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Cms/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Shop/cateDel/',array('id'=>$vo2['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
								</tr>
								<?php if(is_array($vo2['_child'])): foreach($vo2['_child'] as $key=>$vo3): ?><tr id="item<?php echo ($vo3["id"]); ?>">
									...
									<td class="center "><a href="<?php echo U('Cms/Shop/cateSet/',array('id'=>$vo3['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a><?php if(empty($vo3["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Cms/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Shop/cateDel/',array('id'=>$vo3['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
									</tr>
											<?php if(is_array($vo3['_child'])): foreach($vo3['_child'] as $key=>$vo4): ?><tr id="item<?php echo ($vo4["id"]); ?>">
														<td>
															<empyt name="vo4.soncate">
															<div class="checkbox" style="margin-bottom: 0px; margin-top: 0px;">
																<label style="padding-left: 4px;"> <input name="checkvalue" type="checkbox" class="colored-blue Joel-check" value="<?php echo ($vo4["id"]); ?>">
														...
														<td class="center "><a href="<?php echo U('Cms/Shop/cateSet/',array('id'=>$vo4['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a><?php if(empty($vo4["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Cms/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Shop/cateDel/',array('id'=>$vo4['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
														</tr>
											<?php if(is_array($vo4['_child'])): foreach($vo4['_child'] as $key=>$vo5): ?><tr id="item<?php echo ($vo5["id"]); ?>">
														<td>
															<?php if(empty($vo4["soncate"])): ?><div class="checkbox" style="margin-bottom: 0px; margin-top: 0px;">
																<label style="padding-left: 4px;"> <input name="checkvalue" type="checkbox" class="colored-blue Joel-check" value="<?php echo ($vo5["id"]); ?>">
							                                     <span class="text"></span>
																</label>                                    
							                                </div><?php endif; ?>
														</td>
														...
														<td class="center "><a href="<?php echo U('Cms/Shop/cateSet/',array('id'=>$vo5['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="设置分组"><i class="fa fa-edit"></i> 编辑</a><?php if(empty($vo5["soncate"])): ?>&nbsp;&nbsp;<a href="<?php echo U('Cms/Shop/cate/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Shop/cateDel/',array('id'=>$vo5['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a><?php endif; ?></td>
