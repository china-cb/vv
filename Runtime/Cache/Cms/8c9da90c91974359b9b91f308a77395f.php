<?php if (!defined('THINK_PATH')) exit();?><div class="row">
	<div class="col-lg-4 col-sm-6 col-xs-12">
		<div class="databox databox-lg radius-bordered databox-shadowed databox-graded">
			...
			<div class="databox-right" style="width:78%;float:left;">
				<span class="databox-number azure">会员：&nbsp;&nbsp;<?php echo ($viptotal); ?>人</span>
	...
	<div class="col-lg-4 col-sm-6 col-xs-12">
		<div class="databox databox-lg radius-bordered databox-shadowed databox-graded">
			...
			<div class="databox-right" style="width:78%;float:left;">
				<span class="databox-number azure">分销课程：&nbsp;&nbsp;<?php echo ($ordertotal); ?></span>
	...
	<div class="col-lg-4 col-sm-6 col-xs-12">
		<div class="databox databox-lg radius-bordered databox-shadowed databox-graded">
			<div style="padding:15px;border-radius: 50%;width:17%;margin:2% 0 0 10px;background-color:#a0d468;float:left;">
				<a href="#" >
					<img src="/Public/Cms/img/fxs.png" width="100%">
				</a>
			</div>
			...
			<div class="databox-right" style="width:78%;float:left;">
				<span class="databox-number azure">分销商：&nbsp;&nbsp;<?php echo ($fxstotal); ?></span>
		...
		<div class="databox databox-xlg radius-bordered databox-shadowed databox-vertical">
			<div class="databox-top bg-palegreen">
				<span class="databox-header">分销商分布【有效总数：<?php echo ($fxstotal); ?>人】</span>
			</div>
			<div class="databox-bottom bg-white no-padding" style=" height: 230px;">
...
<script type="text/javascript">
	...
	var fxwrap = $("#fx-chart");
	var fxdata = [
            	{ label: "一级分销商", data: [[1, fx1]], color: themeprimary },
            	{ label: "二级分销商", data: [[1, fx2]], color: themesecondary },
            	{ label: "三级分销商", data: [[1, fx3]], color: themethirdcolor }
     ];
