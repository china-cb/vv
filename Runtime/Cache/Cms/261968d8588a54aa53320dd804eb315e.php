		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Cms/Shop/labelSet/');?>" class="btn btn-primary" data-loader="Joel-loader" data-loadername="标签设置">
					...
					<div class="pull-right">
						<form id="Joel-search">
							<label style="margin-bottom: 0px;">
								<input name="name" type="search" class="form-control input-sm" placeholder="按标签名搜索" value="<?php echo ($name); ?>">
							</label>
							<a href="<?php echo U('Cms/Shop/label/');?>" class="btn btn-success" data-loader="Joel-loader" data-loadername="标签列表" data-search="Joel-search">
				...
				<table id="Joel-table" class="table table-bordered table-hover">
					<thead class="bordered-darkorange">
						<tr role="row">
							...
							<th width="80px">ID</th>
							<th width="150px">标签名称</th>
							<th width="150px">标签图片</th>
							<th width="150px">图片</th>
							<th width="150px">专题图片</th>
							<th>标签说明</th>
							<th>操作</th>
						</tr>
					</thead>
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class=" "><img src="<?php echo ($vo["limgurl"]); ?>" height="30px" /></td>
								<td class=" "><img src="<?php echo ($vo["imgurl"]); ?>" height="30px" /></td>
								<td class=" "><img src="<?php echo ($vo["spimgurl"]); ?>" height="30px" /></td>
								<td class=" "><?php echo ($vo["summary"]); ?></td>
								<td class="center "><a href="<?php echo U('Cms/Shop/labelSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="标签设置"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;<a href="<?php echo U('Cms/Shop/label/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Shop/labelDel/',array('id'=>$vo['id']));?>" ><i class="fa fa-trash-o"></i> 删除</a></td>
...
<script type="text/javascript">
	...
	$('#Joel-delall').on('click',function(){
		...
		var toajax="<?php echo U('Cms/Shop/labelDel');?>"+"/id/"+chk;
		var callok=function(){
			//主框架可以直接模拟点击刷新按钮
