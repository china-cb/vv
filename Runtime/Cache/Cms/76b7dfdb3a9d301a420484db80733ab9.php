        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <!--微信管理-->                    
                    <?php if(in_array(($wx), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                        <a href="#" class="menu-dropdown">
                    ...
                    <!--会员中心-->                    
                    <!--<?php if(in_array(($vip), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                        <a href="#" class="menu-dropdown">
...
<!--分销课程管理-->
                    <?php if(in_array(($shop), is_array($useroath)?$useroath:explode(',',$useroath))): ?><li>
                        <a href="#" class="menu-dropdown">
                            ...
                            <span class="menu-text"> 分销课程管理 </span>
                            <i class="menu-expand"></i>
                        </a>
                        <ul class="submenu">
                            <li>
                                <a href="<?php echo U('Cms/Shop/order');?>" data-loader="Joel-loader" data-loadername="分销课程管理-全部课程">
	                                <span class="menu-text">全部分销课程</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo U('Cms/Shop/order');?>" data-loader="Joel-loader" data-loadername="分销课程管理-数据统计">
	                                <span class="menu-text">分销数据统计</span>
                                </a>
                            </li>     
                        </ul>
                    </li><?php endif; ?>
