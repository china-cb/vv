		...
		<div class="widget">
			...
			<div class="widget-body">
				<div class="table-toolbar">
					<a href="<?php echo U('Cms/Wx/keywordSet/');?>" class="btn btn-primary" data-loader="Joel-loader" data-loadername="设置分组">
					...
					<div class="pull-right">
						<!--<form id="Joel-search">
							...
							<a href="<?php echo U('Cms/Wx/keyword/');?>" class="btn btn-success" data-loader="Joel-loader" data-loadername="关键词列表" data-search="Joel-search">
				...
				<table id="Joel-table" class="table table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
								...
								<td class=" "><?php if(($vo["type"]) == "3"): ?><a href="<?php echo U('Cms/Wx/img/',array('kid'=>$vo['id']));?>" class="btn btn-azure btn-xs" data-loader="Joel-loader" data-loadername="多图文管理"><i class="fa fa-edit"></i> 管理</a><?php else: ?>未启用<?php endif; ?></td>
								<td class="center "><a href="<?php echo U('Cms/Wx/keywordSet/',array('id'=>$vo['id']));?>" class="btn btn-success btn-xs" data-loader="Joel-loader" data-loadername="设置关键词"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;<a href="<?php echo U('Cms/Wx/keyword/');?>" class="btn btn-danger btn-xs" data-type = "del" data-ajax="<?php echo U('Cms/Wx/keywordDel/',array('id'=>$vo['id']));?>"><i class="fa fa-trash-o"></i> 删除</a></td>
...
<script type="text/javascript">
	...
	$('#Joel-delall').on('click',function(){
		...
		var toajax="<?php echo U('Cms/Wx/keywordDel');?>"+"/id/"+chk;
		var funok=function(){
			var callok=function(){
				//成功删除后刷新
