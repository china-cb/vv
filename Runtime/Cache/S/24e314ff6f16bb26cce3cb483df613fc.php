          ...
          <div class="widget radius-bordered">
              ...
              <div class="widget-body">
                  ...
                  <div class="form-title">
                        <a href="<?php echo U('S/Shop/order/',array('status'=>$status));?>" class="btn btn-primary" data-loader="Joel-loader" data-loadername="我的订单">
                   ...
                   <?php if($cache["msg"] != ''): ?><div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-lg-4">
                        	...
                        	'<?php switch($cache["paytype"]): case "money": ?>余额支付<?php break;?>
								<?php case "alipaywap": ?>支付宝WAP支付<?php break; endswitch;?>' readonly>
                        </div>
                   </div>
